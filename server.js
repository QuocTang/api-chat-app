  ...
  socket.on("handle group", (data) => {
    ...
    switch (action) {
      ...
      case REMOVE_USER_GROUP_CHAT:
        io.emit("remove", payload);
        break;
      case UPDATE_GROUP_NAME:
        io.emit("update", payload);
        break;
      case ADD_USERS_GROUP:
        io.emit("add group", payload);
        break;
      case ADD_USERS_SINGLE:
        io.emit("add single", payload);
        break;
      case DELETE_GROUP_CHAT:
        io.emit("remove group chat", payload);
        break;
      default:
